...
**When to use this vs. an ADR:** Use the decision log for any decision you want to record. Promote a decision to a formal [ADR](../latest/adrs/) when it meets one or more of these criteria:
...
| --- | ---- | -------- | --------- | ----- | ------------------------------ |
| 1   |      |          |           |       | — / [ADR-XXXX](../latest/adrs/) |
| 2   |      |          |           |       | — / [ADR-XXXX](../latest/adrs/) |
