...
## Inputs
- layers/layer-1-product/latest/** (product specs)
- layers/layer-2-design/latest/** (UX specs, if applicable)
- layers/layer-3-architecture/latest/** (architecture, ADRs, feature technical specs)

## Outputs
- Readiness report in layers/layer-3-architecture/intermediate/readiness-report.md

## Steps (TODO)
1. Scan Layer 1 latest/ for feature specs — check status: consensus
2. Scan Layer 2 latest/ for UX specs — check status: consensus (skip if N/A)
3. Scan Layer 3 latest/ for architecture and ADRs — check status: consensus
